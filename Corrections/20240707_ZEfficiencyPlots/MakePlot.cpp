...
string OutputBase = "/eos/home-p/pchou/figs/ZHadron2024/ZeeEfficiency/20240911/vF/";
...
int main()
{
   ...
   TChain* TPbPb = new TChain("Tree"); TPbPb->Add("../20240706_ZeeEfficiency/PbPb_0911_vF/*.root");
