...
Common="--MinZPT 40 --MaxZPT 200 --MinTrackPT 1 --MaxTrackPT 1000 --DoSumET false"
...
TrackResidualPathPbPb="${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_0_20.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_20_60.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_60_100.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_100_200.root"
TrackResidualPathPbPbMB="${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_0_20_MB.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_20_60_MB.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_60_100_MB.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_100_200_MB.root"
TrackResidualPathPbPbNoZ="${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_0_20_NoZ.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_20_60_NoZ.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_60_100_NoZ.root,${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_100_200_NoZ.root"
TrackResidualPathPP="${ProjectBase}/CommonCode/root/20240910_TrackResidualCorrection_V3_pp.root"
...
DHSet Setting.dh PbPbBackgroundData  Nominal  string "$Common $Data  --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundData"
DHSet Setting.dh PbPbBackgroundMC    UEUp25   string "$Common $MC    --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundMCUEUp25"
DHSet Setting.dh PbPbBackgroundGenMC UEUp25   string "$Common $MCGen --IsPP false $MiniAODPF $GenTrack   	   $BackgroundGenMCUEUp25"
DHSet Setting.dh PbPbBackgroundData  UEUp25   string "$Common $Data  --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundDataUEUp25"
DHSet Setting.dh PbPbBackgroundMC    UEDown25 string "$Common $MC    --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundMCUEDown25"
DHSet Setting.dh PbPbBackgroundGenMC UEDown25 string "$Common $MCGen --IsPP false $MiniAODPF $GenTrack    	   $BackgroundGenMCUEDown25"
DHSet Setting.dh PbPbBackgroundData  UEDown25 string "$Common $Data  --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundDataUEDown25"
DHSet Setting.dh PbPbBackgroundMC    UEUp30   string "$Common $MC    --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundMCUEUp30"
DHSet Setting.dh PbPbBackgroundGenMC UEUp30   string "$Common $MCGen --IsPP false $MiniAODPF $GenTrack 	      $BackgroundGenMCUEUp30"
DHSet Setting.dh PbPbBackgroundData  UEUp30   string "$Common $Data  --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundDataUEUp30"
DHSet Setting.dh PbPbBackgroundMC    UEDown30 string "$Common $MC    --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundMCUEDown30"
DHSet Setting.dh PbPbBackgroundGenMC UEDown30 string "$Common $MCGen --IsPP false $MiniAODPF $GenTrack    	   $BackgroundGenMCUEDown30"
DHSet Setting.dh PbPbBackgroundData  UEDown30 string "$Common $Data  --IsPP false $MiniAODPF $PbPbMBRecoTrack  $BackgroundDataUEDown30"
